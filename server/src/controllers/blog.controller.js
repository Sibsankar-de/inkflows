...
const updateTagList = asyncHandler(async (req, res) => {
  ...
  return res.status(200).json(new ApiResponse(200, blog, 'Taglist updated'));
});
...
const updateThumbnail = asyncHandler(async (req, res) => {
  ...
  return res.status(200).json(new ApiResponse(200, blog, 'Thumbnail updated'));
});
...
const updateBlogUploadStatus = asyncHandler(async (req, res) => {
  ...
  return res.status(200).json(new ApiResponse(200, blog, 'Blog status updated'));
});
...
const createBlogContribution = asyncHandler(async (req, res) => {
  ...
  return res.status(200).json(new ApiResponse(200, contribution, 'Contributor created'));
});
...
const setContributionResponse = asyncHandler(async (req, res) => {
  ...
  if (!contribution || contribution?.userId !== req.user._id)
  ...
  return res.status(200).json(new ApiResponse(200, {}, 'Contribution request accepted'));
});
...
const removeContribution = asyncHandler(async (req, res) => {
  ...
  if (
    contribution.userId.toString() === req.user._id.toString() ||
    blog.creator.toString() === req.user._id.toString()
  ) {
  ...
  return res.status(200).json(new ApiResponse(200, {}, 'Contribution removed'));
});
...
const getContributorList = asyncHandler(async (req, res) => {
  ...
  return res.status(200).json(new ApiResponse(200, contributorList, 'List fetched'));
});
...
const getBlogList = asyncHandler(async (req, res) => {
  ...
  return res.status(200).json(new ApiResponse(200, blogList, 'Bloglist fetched fuccessfully'));
});
...
const getUserBlogList = asyncHandler(async (req, res) => {
  ...
  return res.status(200).json(new ApiResponse(200, blogList, 'Blog list fetched successfully'));
});
  ...
  return res
    ...
    .json(
      new ApiResponse(
        200,
        {
          draftBlogCount: draftBlogList?.length || 0,
          publicBlogCount: publicBlogList?.length || 0,
          contributionCount: contriButionList?.length || 0,
        },
        'Blog number fetched successfully'
      )
    );
});
...
const addViews = asyncHandler(async (req, res) => {
  ...
  return res.status(200).json(new ApiResponse(200, {}, 'Views added successfully'));
});
...
const addToSaveList = asyncHandler(async (req, res) => {
  ...
  return res.status(200).json(new ApiResponse(200, {}, 'Blog added to save list'));
});
...
const removeFromSaveList = asyncHandler(async (req, res) => {
  ...
  return res.status(200).json(new ApiResponse(200, {}, 'Blog removed from save list'));
});
...
const getSavedBlogsIdList = asyncHandler(async (req, res) => {
  ...
  return res
    .status(200)
    .json(
      new ApiResponse(200, savedPosts?.length > 0 && savedPosts[0], 'Saved blog id list fetched')
    );
});
...
const getSavedBlogList = asyncHandler(async (req, res) => {
  ...
  return res.status(200).json(new ApiResponse(200, savedPosts, 'Saved list created successfully'));
});
...
const getSearchResult = asyncHandler(async (req, res) => {
  ...
  const searchResult = [
    ...userList?.map((e) => {
      return { type: 'user', content: e };
    }),
    ...blogResult?.map((e) => {
      return { type: 'blog', content: e };
    }),
  ];
