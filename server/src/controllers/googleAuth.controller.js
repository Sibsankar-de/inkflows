...
const getAuthenticatedUser = asyncHandler(async (req, res) => {
  ...
  return res.status(200).json(new ApiResponse(200, response?.data, 'User fetched sucessfully'));
});

export { authenticateUser, registerAuthenticatedUser, getAuthenticatedUser };
