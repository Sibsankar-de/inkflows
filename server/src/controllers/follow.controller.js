...
const createFollow = asyncHandler(async (req, res) => {
  ...
  return res.status(200).json(new ApiResponse(200, {}, 'Follow successfully'));
});
...
const checkFollow = asyncHandler(async (req, res) => {
  ...
  return res.status(200).json(new ApiResponse(200, { isFollowed }, 'Follow fetched'));
});

export { createFollow, removeFollow, checkFollow };
